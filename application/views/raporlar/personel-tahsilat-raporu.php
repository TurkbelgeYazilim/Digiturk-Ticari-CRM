...
<html lang="tr">
<head>
    <title>Personel Tahsilat Raporu | İlekaSoft CRM</title>
...
<body>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">💰 Personel Tahsilat Raporu</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Anasayfa</a></li>
                                <li class="breadcrumb-item">Raporlar</li>
                                <li class="breadcrumb-item active">Personel Tahsilat Raporu</li>
                            </ul>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="card stat-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Toplam Tahsilat Adedi</h6>
                    ...
                    <div class="col-xl-4 col-sm-6 col-12">
                        <div class="card stat-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Toplam Tahsilat Tutarı</h6>
                    ...
                    <div class="col-xl-4 col-sm-6 col-12">
                        <div class="card stat-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Ortalama Tahsilat</h6>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fa fa-table"></i> Personel Bazlı Tahsilat Özet Raporu</h5>
                    </div>
                    <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        var table = $('#dataTable').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '<?= base_url("raporlar/personel_tahsilat_raporu_ajax") ?>',
                type: 'POST',
                data: function(d) {
        ...
        $(document).on('click', '.detay-goster', function() {
            ...
            var tahsilatTipi = $(this).data('tahsilat-tipi');
        ...
        $('#exportExcelBtn').on('click', function() {
            var url = '<?= base_url("raporlar/personel_tahsilat_raporu_excel") ?>';
            url += '?baslangic_tarih=' + $('#baslangic_tarih').val();
            url += '&bitis_tarih=' + $('#bitis_tarih').val();
