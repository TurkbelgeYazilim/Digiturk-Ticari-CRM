        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <h3 class="page-title tabii-title"><?= $isEditMode ? 'TABII Aktivasyon Düzenle' : 'TABII Aktivasyon Oluştur' ?></h3>
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active tabii-title"><?= $isEditMode ? 'TABII Düzenle' : 'TABII Oluştur' ?></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card tabii-card">

                        <div class="card-body">

                            <h4 class="card-title tabii-title"><?= $isEditMode ? 'TABII Aktivasyon Düzenle' : 'Yeni TABII Aktivasyon Oluştur' ?></h4>

                            

                            <form action="<?= base_url('aktivasyon/tabii-kaydet') ?>" method="POST" id="aktivasyonForm">
                                ...
                                <!-- TABII Aktivasyon Bilgileri - 2. Satır -->
                                <div class="row">
                                    <!-- Üye No -->
                                    <div class="form-group col-md-2">
                                ...
                                <!-- TABII Aktivasyon Bilgileri - 3. Satır -->
                                <div class="row">
                                    <!-- Üye No -->
                                    <div class="form-group col-md-2">
                                ...
                                <!-- TABII Aktivasyon Bilgileri - 4. Satır -->
                                <div class="row">
                                    <!-- Üye No -->
                                    <div class="form-group col-md-2">
                                ...
                                <!-- TABII Aktivasyon Bilgileri - 5. Satır -->
                                <div class="row">
                                    <!-- Üye No -->
                                    <div class="form-group col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="aciklama" id="aciklama" rows="3" 
                                                  ...
                                                  placeholder="TABII aktivasyon ile ilgili açıklama giriniz"><?= $isEditMode ? $aktivasyon->aktivasyon_aciklama : '' ?></textarea>
                                ...
                                <div id="musteriDetayAlani" style="display: none;">
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <h5 class="card-title mb-0 tabii-title">TABII Müşteri Bilgileri</h5>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <h6 class="text-primary mb-3">
                                                        ...
                                                        <i class="fa fa-money"></i> TABII Tahsilat Bilgileri
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary tabii-btn">

                                                <i class="fa fa-save"></i> 

                                                <?= $isEditMode ? 'TABII Güncelle' : 'TABII Kaydet' ?>
...
$(document).ready(function() {
    ...
    $('#cari_id').select2({
        ...
        placeholder: 'TABII müşteri ara ve seç...',
        ...
        ajax: {
            ...
            data: function (params) {
                ...
                return {
                    ...
                    stok_grup_id: 2 // TABII için stok grup ID
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.tahsilatlar && response.tahsilatlar.length > 0) {
                    ...
                    tahsilatHtml = '<div class="alert alert-info"><i class="fa fa-info-circle"></i> Bu TABII müşteri için henüz tahsilat kaydı bulunmamaktadır.</div>';
    ...
    $('#aktivasyonForm').on('submit', function(e) {
        ...
        if (!cariId) {
            ...
            alert('Lütfen bir TABII müşteri seçiniz.');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        alert('TABII görsel başarıyla yüklendi.');
                        ...
                        alert('TABII görsel yüklenirken hata oluştu: ' + (response.message || 'Bilinmeyen hata'));
                ...
                error: function(xhr, status, error) {
                    ...
                    alert('TABII görsel yüklenirken hata oluştu. Lütfen tekrar deneyiniz.');
