        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-10">
                        ...
                        ?>
                        <h3 class="page-title"><?= $isEditMode ? 'Aktivasyon Düzenle' : 'Aktivasyon Oluştur' ?></h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Anasayfa</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('aktivasyon'); ?>">Aktivasyon</a></li>
                            <li class="breadcrumb-item active"><?= $isEditMode ? 'Düzenle' : 'Oluştur' ?></li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><?= $isEditMode ? 'Aktivasyon Düzenle' : 'Yeni Aktivasyon Oluştur' ?></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="aciklama" id="aciklama" rows="3" 
                                                  placeholder="Aktivasyon ile ilgili açıklama giriniz"><?= $isEditMode ? $aktivasyon->aktivasyon_aciklama : '' ?></textarea>
                                    </div>
                                </div>
